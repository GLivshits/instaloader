        ...
        for target in targetlist:
            ...
            with instaloader.context.error_catcher(target):
                if re.match(r"^@[A-Za-z0-9._]+$", target):
                    ...
                    instaloader.get_profiles_hashtag(hashtag=target[1:], max_count=max_count, fast_update=fast_update,
                                                 post_filter=post_filter,
                                                 profile_pic=download_profile_pic, posts=download_posts, get_profiles = True)
...
def main():
    ...
    try:
        ...
        loader = Instaloader(sleep=not args.no_sleep, quiet=args.quiet, user_agent=args.user_agent,
                             dirname_pattern=args.dirname_pattern, filename_pattern='{target}',
                             ...
                             rapidapi_key=args.rapidapi_key, use_proxy=False)
        _main(loader,
              args.profile,
